...
<template>
  <Card class="p-2">
    <template #content>
      <DataTable :value="corps" v-model:selection="selectedCorps" v-model:filters="filters"
        :globalFilterFields="['name', 'years']" filterDisplay="row" @rowSelect="selectCorps" selectionMode="single"
        sortMode="single" sortField="name" scrollable dataKey="id" tableStyle="min-width: 60rem">
        <template #header>
